        ...
        <AuthenticatedLayout>
            ...
            <div className="py-10">
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white shadow-sm sm:rounded-2xl border border-slate-200/60">
                        <div className="px-6 py-6 sm:px-8">
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    <p className="text-sm text-slate-500">Settings</p>
                                    <h2 className="text-2xl font-semibold text-slate-900">Accountant Emails</h2>
                                    <p className="mt-2 text-sm text-slate-600">
                                        Define email recipients and an optional message that will appear in the exported emails.
                                    </p>
                                </div>
                                {flash?.success && (
                                    <div className="rounded-full bg-emerald-50 px-4 py-2 text-sm font-semibold text-emerald-700 border border-emerald-100">
                                        {flash.success}
                                    </div>
                                )}
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-slate-500">Separate each email with a semicolon (;)</p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-slate-500">Plain text only - HTML tags will be stripped for security</p>
                                </div>
